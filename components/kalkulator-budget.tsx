  ...
  return (
    <div className="bg-slate-900 p-6 sm:p-8 text-white relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 relative z-10">
        ...
        <div>
          <h3 className="font-display font-extrabold text-2xl tracking-tight mb-1 leading-tight">Kalkulator Estimasi</h3>
          <p className="text-slate-300 text-sm md:text-base font-medium leading-relaxed">Hitung estimasi investasi program Anda dengan cepat</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <input
        ...
        className="w-full h-3 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-red-500 hover:accent-red-600 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
      />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
         {PROGRAMS.map((p) => (
            <button
              ...
              className={`px-4 py-3 rounded-2xl text-sm md:text-base font-bold transition-all duration-300 border-2 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 ${
                program.id === p.id
  ...
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-[2rem] p-6 sm:p-8 text-center space-y-6 relative overflow-hidden">
       ...
       <div>
         ...
         <p className="font-display font-black text-4xl sm:text-5xl text-slate-900 tracking-tight leading-relaxed">
       ...
       <button
         ...
         className="w-full flex items-center justify-center gap-3 bg-red-500 hover:bg-red-600 text-white font-bold text-xl py-4 px-6 rounded-2xl transition-all duration-300 active:scale-95 shadow-xl shadow-red-500/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
       >
  ...
  return (
    <div className="bg-white rounded-[2rem] border border-slate-100 shadow-xl overflow-hidden max-w-2xl mx-auto">
      ...
      <div className="p-6 sm:p-8 space-y-8">
        <PesertaSlider pax={pax} setPax={setPax} />
        <ProgramSelection program={program} setProgram={setProgram} />
        <DurationSelection duration={duration} setDuration={setDuration} />
