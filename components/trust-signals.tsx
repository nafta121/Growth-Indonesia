      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 mt-20 md:mt-32">
        ...
        <div className="flex overflow-x-auto gap-4 sm:gap-6 pb-12 pt-4 px-4 -mx-4 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          {TESTIMONIALS.map((t, idx) => (
            <div 
              key={idx}
              className="flex-none w-[85vw] sm:w-full max-w-sm md:max-w-md snap-center shrink-0 bg-white border border-gray-100 rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-xl hover:shadow-red-500/5 hover:-translate-y-1 hover:border-red-100 transition-all duration-300 relative group"
            >
