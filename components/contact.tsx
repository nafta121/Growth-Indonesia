            ...
            <div className="space-y-6 md:space-y-8">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-500 group-hover:text-gray-900 transition-colors duration-300 text-sm md:text-base font-bold leading-relaxed">{COMPANY_INFO.whatsapp_display}</p>
                </div>
              </a>

              <a 
                href={`mailto:${COMPANY_INFO.email}`}
                className="flex gap-5 md:gap-7 group items-center p-4 -ml-4 rounded-3xl hover:bg-gray-50 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-500 group-hover:text-gray-900 transition-colors duration-300 text-sm md:text-base border-b border-transparent group-hover:border-gray-200 leading-relaxed">{COMPANY_INFO.email}</p>
                </div>
              </a>
            </div>
          </motion.div>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 md:space-y-6" aria-labelledby="kontak-form-title">
                    ...
                    <div className="space-y-2 relative">
                      ...
                      <select
                        ...
                        className="w-full h-14 md:h-16 px-6 bg-white border border-gray-200 rounded-2xl focus-visible:ring-2 focus-visible:ring-red-500/10 focus-visible:border-red-500 outline-none transition-all duration-300 text-sm md:text-base font-medium appearance-none cursor-pointer"
                      >
