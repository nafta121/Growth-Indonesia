          ...
          >
            ...
            <div className="space-y-6 md:space-y-8">
              <a 
                ...
                className="flex gap-5 md:gap-7 group items-center p-4 -ml-4 rounded-3xl hover:bg-gray-50 transition-all duration-300 min-h-[48px] min-w-[48px]"
              ...
              <a 
                ...
                className="flex gap-5 md:gap-7 group items-center p-4 -ml-4 rounded-3xl hover:bg-gray-50 transition-all duration-300 focus-visible:outline-none"
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 md:space-y-6" aria-labelledby="kontak-form-title">
                    ...
                    <div className="space-y-2 relative">
                      ...
                      <select
                        ...
                        className="w-full h-14 md:h-16 px-6 bg-white border border-gray-200 rounded-2xl focus-visible:ring-2 focus-visible:ring-[#EF4444]/10 focus-visible:border-red-500 outline-none transition-all duration-300 text-sm md:text-base font-medium appearance-none cursor-pointer"
                      >
