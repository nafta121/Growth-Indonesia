                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <button 
                      ...
                      className="mt-12 text-gray-500 hover:text-[#EF4444] transition-colors text-[10px] font-bold uppercase tracking-[0.2em] underline underline-offset-8 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#EF4444] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A1628]"
                    >
                      Kirim Pesan Lain
                    </button>
                  </div>
