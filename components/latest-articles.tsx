    ...
    <section className="py-20 md:py-28 bg-gray-50 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center">
          <Link
            href="/artikel"
            className="inline-flex items-center justify-center bg-slate-900 hover:bg-slate-800 text-white font-extrabold px-8 py-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-red-500/5 text-sm md:text-base uppercase tracking-wider"
          >
            Lihat Semua Artikel
