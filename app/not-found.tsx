  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-white px-4 md:px-12 relative overflow-hidden" style={{ paddingTop: '80px' }}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-full max-w-lg h-auto aspect-square bg-slate-900/5 rounded-full blur-[150px] animate-pulse delay-700" />
      </div>
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        <div className="w-24 h-24 bg-red-50 rounded-3xl mx-auto flex items-center justify-center mb-8 rotate-12 hover:rotate-0 transition-transform duration-500 shadow-sm border border-red-100">
          <span className="text-4xl font-black text-red-500">404</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link 
            ...
            className="w-full sm:w-auto h-14 px-8 rounded-full bg-red-500 text-white hover:bg-red-600 shadow-lg shadow-red-600/30 transition-all duration-300 active:scale-95 flex items-center justify-center gap-2 text-sm font-bold"
          >
