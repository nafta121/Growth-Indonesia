...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Event Organizer Madiun & Provider Outbound | Growth Indonesia',
    template: '%s | Growth Indonesia',
  },
  description: 'Event organizer & provider outbound Madiun bersertifikat BNSP. Melayani corporate gathering, team building & LDK OSIS. Konsultasi gratis & penawaran terbaik!',
  keywords: [
  ...
  openGraph: {
    title: 'Event Organizer Madiun & Provider Outbound | Growth Indonesia',
    description: 'Event organizer & provider outbound Madiun bersertifikat BNSP. Melayani corporate gathering, team building & LDK OSIS. Konsultasi gratis & penawaran terbaik!',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Event Organizer Madiun & Provider Outbound - Growth Indonesia',
      },
    ],
  },
  twitter: {
